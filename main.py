...
ammehjelpen_db = Chroma(persist_directory="./vectorstores/ammehjelpen_chroma_db", embedding_function=embeddings)
ammehjelpen_retriever = ammehjelpen_db.as_retriever()

brewshop_db = Chroma(persist_directory="./vectorstores/brewshop_chroma_db", embedding_function=embeddings)
brewshop_retriever = brewshop_db.as_retriever()

loplabbet_db = Chroma(persist_directory="./vectorstores/loplabbet_chroma_db", embedding_function=embeddings)
loplabbet_retriever = loplabbet_db.as_retriever()
...
async def privacy_policy():
    ...
    privacy_text = """
    Privacy Policy for the GPT API calls

Last Updated: 2023-11-18

1. Introduction

Welcome to the GPT API. We are committed to respecting your privacy and protecting your personal information. This Privacy Policy explains the types of information we collect through our API and how we use this information.

2. Information We Collect

The GPT API is designed to collect only the information that is necessary to provide our service. The only data we collect is:
